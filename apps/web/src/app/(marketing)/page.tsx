      ...
      >
        <div style={{ maxWidth: 760, color: "white" }}>
          ...
          <div className="row gap-2" style={{ flexWrap: "wrap" }}>
            <Link className="btn primary" href="/register" onClick={() => trackProductEvent(PRODUCT_EVENTS.alphaApplicationClicked, { source: "marketing_home", intent: "apply_alpha" })}>申请 Alpha</Link>
            <Link className="btn" href="/register?intent=feedback" onClick={() => trackProductEvent(PRODUCT_EVENTS.alphaApplicationClicked, { source: "marketing_home", intent: "feedback" })}>反馈 Alpha 方向</Link>
