...
export const SEEDS = {
  memory: {
    ...
    responseChunks: [
      ...
      "\n\n**4. 阶级化。** 越完整的人生越值钱。穷人卖记忆维生，富人买记忆扩展阅历。这一层不必明说，让它在故事种子里自然浮现。",
      "\n\n我在档案侧识别出 **3 条可保存设定**、**1 项潜在冲突**、**3 个故事种子**。你可以决定哪些保存到世界档案。",
      "\n\n你想先收束「制度层」，还是直接顺着「虚空印记」做一个故事种子？"
    ],
    ...
    suggestions: [
      ...
      {
        id: "seed1", kind: "seed", category: "故事种子",
        title: "继承的童年",
      ...
      {
        id: "seed2", kind: "seed", category: "故事种子",
        title: "完整人生 #1947",
      ...
      {
        id: "seed3", kind: "seed", category: "故事种子",
        title: "审判席上的买家",
