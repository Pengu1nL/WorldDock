...
function WorldDockRuntime() {
  ...
  const startAgentRun = useCallback((userText: string, isInitial = false) => {
    if (agentBusy) return;
    ...
    tick();
  }, [agentBusy, agentMode, balance, mockFailure, pushToast, seedData, t.mode]);
