...
- [x] **Step 1: 在 public API integration 中补充 access token 不可再签发 PAT 的断言**
...
- [x] **Step 3: 若 Step 2 暴露实现漂移，做最小修复**
...
- [x] **Step 1: 让 exports integration 的 in-memory auth repository 支持 access token**
...
- [x] **Step 2: 添加 world package scope integration test**
...
- [x] **Step 4: 若 Step 3 暴露 scope drift，修正 controller decorator**
...
- [x] **Step 5: 重新运行 public API 和 exports 定向测试**
...
- [x] **Step 2: 添加 login 命令 smoke test**
...
- [x] **Step 3: 添加 repository spec 校验测试**
...
- [x] **Step 6: 若 Step 4 或 Step 5 暴露 CLI drift，修正最小实现**
...
- [x] **Step 7: 重新运行 CLI test/lint/build**
...
- [x] **Step 1: 检查产品 API 文档的 endpoint 和 scope**
...
- [x] **Step 2: 检查 CLI 文档命令与真实 CLI 路由一致**
...
- [x] **Step 3: 检查 Alpha public API 文档没有混入 Local Push scope**
...
- [x] **Step 4: 若文档 drift，按当前 contract 修改 `docs/product/api.md`**
...
- [x] **Step 2: 运行 public API 和 world package integration**
...
- [x] **Step 5: 检查文档不再保留 Phase 14 待重新验收表述**
...
- [x] **Step 2: 检查 Phase 14 contract 的三组证据仍在**
...
- [x] **Step 3: 检查工作区只包含 Phase 14 相关改动**
