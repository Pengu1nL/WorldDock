...
- [ ] **Step 1: 写失败测试覆盖 Phase8 API contract**
...
- [ ] **Step 1: 确认根模块接入 CommunityModule**
...
- [ ] **Step 2: 确认 CommunityModule 组合依赖**
...
- [ ] **Step 3: 实现 community repository list controller**
...
- [ ] **Step 1: 增加 detail 和 assets routes**
...
- [ ] **Step 2: 增加 repository contract 读取 fork graph**
...
- [ ] **Step 5: 运行 detail/assets API 测试**
...
- [ ] **Step 1: 确认 Prisma collection 约束**
...
- [ ] **Step 4: 增加 collections controller routes**
...
- [ ] **Step 5: 增加 collections service 方法**
...
- [ ] **Step 1: 在 CommunityView 接入 community API**
...
- [ ] **Step 4: 运行 community E2E 到第一个页面流**
...
- [ ] **Step 4: 渲染 Archive、Seeds、Conflicts**
...
- [ ] **Step 1: CreatorProfilePage 加载 creator 和 repositories**
...
- [ ] **Step 2: CreatorProfilePage 展示仓库入口和统计**
...
- [ ] **Step 3: CommunityView 串联 detail 和 creator**
...
- [ ] **Step 2: 检查 Phase8 无 fixture 回退和旧占位文本**
